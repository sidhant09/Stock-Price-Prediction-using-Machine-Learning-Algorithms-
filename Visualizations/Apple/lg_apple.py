...
extra_serie = {"tooltip": {"y_start": "There are ", "y_end": " calls"}}
chart.add_serie(y=y4, x=xdata, name='Neural Network 37 years ', extra=extra_serie)
#
chart.set_containerheader("<h2>Accuracy rate for Apple stock price prediction <h2>")
chart.buildhtml()
